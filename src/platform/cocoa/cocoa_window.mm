...
- (void)keyDown:(NSEvent *)event {
  ...
  if (flags & NSEventModifierFlagShift)
    ev.modifiers |= static_cast<int>(ltgui::KeyModifier::Shift);
  if (flags & NSEventModifierFlagControl)
    ev.modifiers |= static_cast<int>(ltgui::KeyModifier::Control);
  if (flags & NSEventModifierFlagOption)
    ev.modifiers |= static_cast<int>(ltgui::KeyModifier::Alt);
  if (flags & NSEventModifierFlagCommand)
    ev.modifiers |= static_cast<int>(ltgui::KeyModifier::Super);
...
Size CocoaWindow::getSize() const { return size_; }
...
void *CocoaWindow::nativeHandle() const { return (__bridge void *)nsWindow_; }
...
NativeCanvas *CocoaWindow::getCanvas() { return canvas_; }
