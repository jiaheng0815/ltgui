...
enum class DialogButton { OK = 1, Cancel = 2, Yes = 4, No = 8 };
...
protected:
  ...
  void addButton(const std::string &text, DialogResult res,
...
public:
  ...
  static DialogResult show(Widget *parent, const std::string &title,
...
public:
  ...
  static std::string getText(Widget *parent, const std::string &title,
