...
public:
    ...
    [[deprecated("use currentIndex() instead")]] int selectedIndex() const { return selected_; }
    [[deprecated("use setCurrentIndex() instead")]] void setSelected(int index) { setCurrentIndex(index); }
