...
int main(int argc, char *argv[]) {
  ...
  auto headerLayout =
      std::make_unique<BoxLayout>(BoxLayout::LeftToRight, 8, 12);
  ...
  auto btnSectionLayout =
      std::make_unique<BoxLayout>(BoxLayout::TopToBottom, 6, 0);
  ...
  auto inputRowLayout =
      std::make_unique<BoxLayout>(BoxLayout::LeftToRight, 8, 0);
  ...
  auto selectSectionLayout =
      std::make_unique<BoxLayout>(BoxLayout::LeftToRight, 16, 0);
  ...
  auto progSectionLayout =
      std::make_unique<BoxLayout>(BoxLayout::LeftToRight, 12, 0);
  ...
  auto listColLayout =
      std::make_unique<BoxLayout>(BoxLayout::TopToBottom, 4, 0);
  ...
  auto *aboutText = w3->makeChild<Label>(
      "A from-scratch cross-platform retained-mode C++ GUI framework.");
  ...
  auto *aboutFeatures = w3->makeChild<Label>(
      ...
      "    Slider, ListBox, ComboBox, ScrollArea, TabWidget, TreeView, "
      "ProgressBar\n"
